...
export default function Ingresar(){
 ...
 return <main className="booking"><a href="/">Volver al inicio</a><h1>Ingresar</h1><form onSubmit={password}><label>Correo<input required name="email" type="email"/></label><label>Contrasena<input required name="password" type="password"/></label><button>Ingresar</button><div className="divider"><span>o</span></div><button type="button" className="google" onClick={google}><span className="google-mark">G</span>Continuar con Google</button>{message&&<p>{message}</p>}</form></main>;
}